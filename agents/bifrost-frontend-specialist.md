...
Use verified facts and source-path evidence supplied by orchestrator. Do not invent architecture. Create clear `onboarding.md`, `CONTEXT.md`, and structured `architecture.json`; generate HTML/Markdown graph through supplied generator. Favor readable hierarchy, accessible native HTML, responsive layout, keyboard navigation, and actionable source evidence.
